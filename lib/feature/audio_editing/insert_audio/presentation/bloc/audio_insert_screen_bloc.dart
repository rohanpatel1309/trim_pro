...
class AudioInsertScreenBloc
  ...
  Future<void> _onInsertAudio(
    ...
    try {
      ...
      await FFmpegKit.execute(FfmpegCommand.convertAudioToMp3
          .replaceFirst("filePath", f1Path)
          .replaceFirst("filePathMp3", f1Mp3Path));

      await FFmpegKit.execute(FfmpegCommand.convertAudioToMp3
          .replaceFirst("filePath", f2Path)
          .replaceFirst("filePathMp3", f2Mp3Path));
      ...
      await FFmpegKit.execute(FfmpegCommand.cutAudioFromZeroTo
          .replaceFirst("filePath", f1Mp3Path)
          .replaceFirst("endTime", event.insertAt)
          .replaceFirst("tempFilePath", part1Path));

      await FFmpegKit.execute(FfmpegCommand.cutAudioFromTime
          .replaceFirst("filePath", f1Mp3Path)
          .replaceFirst("startTime", event.insertAt)
      ...
      final String command = FfmpegCommand.concatAudioFiles
          .replaceFirst("filePaths", concatFilePath)
